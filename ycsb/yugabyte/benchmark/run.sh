...
case $1 in
    --load|-l)
        ...
        bin/ycsb load jdbc -P workloads/workload$2 -P db-yuga.properties -p threadcount=$3 -cp postgresql-42.2.14.jar
    ...
    --run|-r)
        ...
        echo "START TIME $(date +'%d-%m-%Y %H:%M:%S')"
        bin/ycsb run jdbc -P workloads/workload$2 -s -P db-yuga.properties -p threadcount=$3 -p operationcount=$4 -cp postgresql-42.2.14.jar
        echo "END TIME $(date +'%d-%m-%Y %H:%M:%S')"
