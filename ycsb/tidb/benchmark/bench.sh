...
case $1 in
    --run|-r)
        ...
        while read  line || [[ -n "$line" ]]; do
            ...
            ssh -nt serverdeploy@$host "cd $path; nohup ./run.sh $1 $2 $3 $4 >>ycsb-tidb.log 2>>ycsb-tidb.log" &
            # sleep 5
    ...
    --load|-l)
        ...
        while read  line || [[ -n "$line" ]]; do
            ...
            echo ">> Script location in $path"
            ssh -nt serverdeploy@$host "cd $path; ./run.sh $1 $2 $3 >>ycsb-tidb-load.log 2>>ycsb-tidb-load.log" &
